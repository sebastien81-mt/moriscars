...
export default function TermsModal({ isOpen, onClose }) {
  ...
  return (
    <div className="terms-modal-overlay" onClick={onClose} role="dialog" aria-modal="true" aria-labelledby="terms-modal-heading">
      <div className="terms-modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="terms-modal-header">
          <div>
            ...
            <h2 id="terms-modal-heading" className="terms-modal-title">Terms of Use</h2>
          </div>
          <button 
            type="button" 
