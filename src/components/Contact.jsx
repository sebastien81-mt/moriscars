        ...
        <div className="contact-grid">
          ...
          <div className="contact-info-column">
            ...
            <p className="contact-brand-sub">
              Modern, reliable, and tourist-friendly car rental in Mauritius. Get in touch for custom vehicle inquiries, airport deliveries, or multi-week stay offers.
            </p>
            ...
            <div className="info-block-group">
              ...
              <div className="info-item">
                ...
                <div>
                  ...
                  <p className="info-val">{siteConfig.locationText}</p>
                </div>
              </div>

              {/* Email (Configurable via siteConfig) */}
              <div className="info-item">
                <div className="info-icon-box">
                  <Mail size={18} />
                </div>
                <div>
                  ...
                  <a href={`mailto:${siteConfig.supportEmail}`} className="info-val info-link">{siteConfig.supportEmail}</a>
                </div>
              </div>
              ...
              <div className="info-item">
                ...
                <div>
                  ...
                  <a href={`tel:${siteConfig.supportPhoneTel}`} className="info-val info-link">{siteConfig.supportPhone} ({siteConfig.operatingHours})</a>
                </div>
              </div>

              {/* WhatsApp Item */}
              <div className="info-item">
                <div className="info-icon-box whatsapp-icon-box">
            ...
            {submitted ? (
              <div className="form-success-alert">
                ...
                <div>
                  ...
                  <p>Thank you for contacting {siteConfig.brandName}. Our team will reply shortly.</p>
                </div>
              </div>
            ) : (
